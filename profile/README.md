...
## Team Agreement
You can view our Team Agreement [here](https://github.com/Interslice-Inc/Interslice/blob/main/Files/PDF's_Files/Team_Agreement.pdf). This agreement outlines guidelines for communication, collaboration, decision-making processes, and conflict resolution within the team.
...
View the full System Selection [here](https://github.com/Interslice-Inc/Interslice/blob/main/Files/PDF's_Files/System_selection.pdf)
...
<summary>Documents</summary>
  ...
  * [Compliance Documentation: Cloud Compliance](https://github.com/Interslice-Inc/Interslice/blob/main/Files/PDF's_Files/Cybersecurity_Compliance.pdf) 
  * [Cloud Security Incident Response Plan for Cromulent Innovations](https://github.com/Interslice-Inc/Interslice/blob/main/Files/PDF's_Files/Incident_Response_Plan.pdf) 

</details>
  
## Topologies/Cloud Architecture Design
Here are some visual representations of Interslice's architecture and topology:
* [General Topology](https://github.com/Interslice-Inc/Interslice/blob/main/Files/Company_Logo/General_TOP.drawio.png)
* [Arch Topology](https://github.com/Interslice-Inc/Interslice/blob/main/Files/Company_Logo/Arch_TOP.drawio.png)
* [Network Infastructure Table](https://github.com/Interslice-Inc/Interslice/blob/main/Files/PDF's_Files/networkinfrastructure.pdf)
* [Attack Architecture Design](https://github.com/Interslice-Inc/Interslice/blob/main/Files/PDF's_Files/AttackArchitectture.drawio.png)
...
* [SSH Brute Force](https://github.com/Interslice-Inc/Interslice/blob/main/Files/Scripts/bruteforce.py) : This script is a collection of security-related tools, including network scanning, brute-force attack simulation, and file encryption for educational and testing purposes.
* [SSH Lambda Script](https://github.com/Interslice-Inc/Interslice/blob/main/Files/Scripts/SSHLambda.py) : This script is intended to notify subscribers of the SNS topic about SSH login attempts by sending an alert message with details of the event. Useful for monitoring and security purposes, allowing administrators to be aware of and respond to potential unauthorized access attempts.
...
Take a view of our project presentation slideshow [here](https://github.com/Interslice-Inc/Interslice/blob/main/Files/PDF's_Files/InterSlice_Presentation.pdf)
